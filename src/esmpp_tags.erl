...
%% @private
pack_null(TmpTag) ->
  Tag    = esmpp_pdu:pad2(binary:encode_unsigned(get_value(TmpTag))),
  Length = esmpp_pdu:pad2(binary:encode_unsigned(?NULL)),
  <<Tag/binary, Length/binary>>.

%% @private
pack_int1(TmpTag, Value) ->
  Tag    = esmpp_pdu:pad2(binary:encode_unsigned(get_value(TmpTag))),
  Length = esmpp_pdu:pad2(binary:encode_unsigned(size(Value))),
  <<Tag/binary, Length/binary, Value/binary>>.

%% @private
pack_int2(TmpTag, TmpValue) ->
  Tag    = esmpp_pdu:pad2(binary:encode_unsigned(get_value(TmpTag))),
  Value  = esmpp_pdu:pad2(binary:encode_unsigned(TmpValue)),
  Length = esmpp_pdu:pad2(binary:encode_unsigned(size(Value))),
  <<Tag/binary, Length/binary, Value/binary>>.

%% @private
pack_int4(TmpTag, TmpValue) ->
  Tag    = esmpp_pdu:pad2(binary:encode_unsigned(get_value(TmpTag))),
  Value  = esmpp_pdu:pad4(binary:encode_unsigned(TmpValue)),
  Length = esmpp_pdu:pad2(binary:encode_unsigned(size(Value))),
  <<Tag/binary, Length/binary, Value/binary>>.

%% @private
pack_string(TmpTag, TmpValue) ->
  Tag    = esmpp_pdu:pad2(binary:encode_unsigned(get_value(TmpTag))),
...
%% @private
pack_cstring(TmpTag, TmpValue, MaxLength) ->
  Tag    = esmpp_pdu:pad2(binary:encode_unsigned(get_value(TmpTag))),
